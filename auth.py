    ...
    if rsa_key:
        try:
            ...
            payload = jwt.decode(
                ...
                issuer='https://check-login.us.auth0.com/'
            )

            print('Done from the Function')
...
def requires_auth(permission=''):
    def requires_auth_decorator(f):
        ...
        def wrapper(*args, **kwargs):
            ...
            print('Returned from verify_decode_jwt successfully !!!')
            # print(payload)
            check_permissions(permission, payload)
            print('Returned from Check_Permission function Successfully !!!')
            print(permission)
            # print(args)
            print(kwargs)
